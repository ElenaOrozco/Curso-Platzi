...
class Archivo extends MY_Controller {
    ...
    public function edit_revisado($idRelDoc_Archivo, $direccion, $tipo_documento, $noHojas) {
        $this->load->model('rel_archivo_documento_model');
    ...
    public function edit_recibido_cid($id, $idRelDoc_Archivo) {
        ...
        $data["idUsuario_recibido_cid"]= $this->session->userdata("id");
                                    ...
                                    if ($qFiltro->num_rows() > 0) {
                                        ...
                                        foreach ($qFiltro->result() as $rFiltro) {
                                           ...
                                           $tabla.= "<tr>";
                                                ...
                                                $tabla.= "<a href='". site_url('archivo/cambios/' . $rFiltro->id) ."' id='preregistro_ubi".$rFiltro->id."' class='btn btn-xs btn-success d-n'><span class='glyphicon glyphicon-pencil'></span></a></td>";
                                                $tabla.=  "<td>" . $rFiltro->OrdenTrabajo . "</td>";
